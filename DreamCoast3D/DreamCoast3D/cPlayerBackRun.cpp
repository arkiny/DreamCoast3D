...
cPlayerBackRun::cPlayerBackRun()
{
	m_nCurrentStateType = cGamePlayableObject::EPLAYABLESTATE::EPLAYABLESTATE_BACKRUN; //2번 (장)Run
...
void cPlayerBackRun::Start(cGamePlayableObject* pPlayer)
{
	cPlayerCommon::Start(pPlayer);
	pPlayer->SetComboCount(0);	//평타 번호 초기화
}
void cPlayerBackRun::Execute(cGamePlayableObject* pPlayer, float fDelta)
{
...
void cPlayerBackRun::Exit(cGamePlayableObject* pPlayer)
{
	cPlayerCommon::Exit(pPlayer);
	// currently do nothing
}
void cPlayerBackRun::MoveFront(cGamePlayableObject* pPlayer, float fDelta)
{
	D3DXVECTOR3 newPos;
...
void cPlayerBackRun::MoveBack(cGamePlayableObject* pPlayer, float fDelta)
{
...
void cPlayerBackRun::MoveRight(cGamePlayableObject* pPlayer, float fDelta)
{
	D3DXVECTOR3 newPos;
	D3DXVECTOR3 curPos = pPlayer->GetPosition();
	D3DXVECTOR3 addVec = (pPlayer->GetFront());
...
void cPlayerBackRun::MoveLeft(cGamePlayableObject* pPlayer, float fDelta)
{
	D3DXVECTOR3 newPos;
	D3DXVECTOR3 curPos = pPlayer->GetPosition();
	D3DXVECTOR3 addVec = (pPlayer->GetFront());
