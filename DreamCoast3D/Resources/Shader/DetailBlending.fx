...
<
string ResourceName = "..\\Documents\\GitHub\\DreamCoast3D\\DreamCoast3D\\Resources\\Map\\terrain_detail_texture.jpg";
>;
...
float4 SpecularMapping_Pass_0_Pixel_Shader_ps_main(PS_INPUT Input) : COLOR
{
	...
	float4 albedo2 = tex2D(DetailSampler, Input.mDUV);

	albedo = albedo*.7 + saturate(albedo2)*.3;
